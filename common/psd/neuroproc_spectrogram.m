function [features, f] = neuroproc_spectrogram(data, wlenght, wshift, pshift, samplerate, mlength)
% [features, f] = neuroproc_spectrogram(data, wlenght, wshift, pshift, samplerate [, mlength])
%
